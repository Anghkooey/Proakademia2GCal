...
**🚀 Втомилися від повільних додатків і заплутаних розкладів? Спробуйте Proakademia2GCal!**

Розроблено **[студентом першого курсу УАФМ](https://uafm.edu.pl/)** 🎓, цей інструмент допоможе легко та швидко імпортувати розклад з **[Proakademia](https://www.dlauczelni.apr.pl/)** у **[Google Календар 🗓️](https://calendar.google.com/)** — з кольоровим маркуванням та кращою організацією!

Чому обрати **Google Календар**?

- ⚡ **Миттєвий доступ з будь-якого пристрою** — відкривайте в браузері або через офіційний мобільний додаток на **iOS** і **Android**
- 🌍 **Працює скрізь, без додаткових встановлень** — розклад завжди під рукою, без зайвих додатків
- 🎨 **Яскраве кольорове кодування:** лекції 🖤, лабораторні 💙, іспити ❤️ — для чіткого й зрозумілого плану

**Proakademia2GCal дозволяє:**

- 🧹 **Очищати та оптимізувати ICS-файл** для гладкого імпорту
- 🗓️ **Автоматично створювати окремий календар «Навчання»** для твоїх занять
- 🧼 **Підтримувати порядок** автоматично видаляючи застарілі події

**Як почати?**

- 🐍 Використовуй Python-скрипт для повного контролю
- 🚀 Або завантаж готові додатки для **[Windows](https://github.com/Anghkooey/Proakademia2GCal/releases)** 💻 та **[Linux](https://github.com/Anghkooey/Proakademia2GCal/releases)** 🐧

**Простіше плануй — краще навчайся!**
